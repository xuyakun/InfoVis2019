...
/* changeMeterial */
function changeMeterial(meterial_val,screen) {
  if (meterial_val == "0") {
    material = new THREE.MeshLambertMaterial();
  } else if (meterial_val == "1") {
