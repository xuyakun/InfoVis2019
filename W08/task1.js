function main()
{
    ...
    {
        var id = faces[i];
        var S0 = Math.floor(((scalars[ id[0] ]-S_min)/(S_max-S_min))*255);
        var S1 = Math.floor(((scalars[ id[1] ]-S_min)/(S_max-S_min))*255);
        var S2 = Math.floor(((scalars[ id[2] ]-S_min)/(S_max-S_min))*255);
